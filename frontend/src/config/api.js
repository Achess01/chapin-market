...
// Product Store
export const getProductsStore = async ({ token, id }) => {
  return await getAllGeneric({ token, path: `${BRANCHES}/${id}/get_products` });
};

export const createProductsStore = async ({ data, token, id }) => {
  return await postGeneric({
    data,
    token,
    path: `${BRANCHES}/${id}/add_products_store`,
  });
};

// Products Shelves
export const getProductsShelves = async ({ token, id }) => {
  return await getAllGeneric({
    token,
    path: `${BRANCHES}/${id}/get_products_shelves`,
  });
};

export const createProductsShelves = async ({ data, token, id }) => {
  return await postGeneric({
    data,
    token,
    path: `${BRANCHES}/${id}/add_products_shelf`,
  });
};
...
export const getTopSales = async ({ token }) => {
  return await getAllGeneric({
    token,
    path: `${SALES}/top`,
  });
...
export const getTopBranches = async ({ token }) => {
  return await getAllGeneric({
    token,
    path: `${BRANCHES}/top`,
  });
